...
const GenericPieChart: React.FC<GenericPieChartProps> = ({ 
  ...
  const chartData = useMemo(() => {
    ...
    // FIX: Explicitly cast `countA` and `countB` to numbers to resolve arithmetic operation error.
    const sortedProviders = Object.entries(providerCounts).sort(([, countA], [, countB]) => Number(countB) - Number(countA));
