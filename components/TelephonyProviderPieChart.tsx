  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center mb-4">
        <DeviceMobileIcon className="h-6 w-6 text-sky-500 mr-3" />
        <h2 className="text-xl font-bold text-slate-800">Ripartizione Contratti Telefonia</h2>
      </div>
      {chartData.providers.length > 0 ? (
        ...
        <div className="text-center py-10 h-full flex flex-col justify-center">
          <p className="text-slate-500">Nessun contratto di telefonia da visualizzare.</p>
        </div>
      )}
    </div>
  );
