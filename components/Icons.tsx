...
export const CurrencyEuroIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.121 15.536A9.004 9.004 0 0112 16c-2.435 0-4.663-.953-6.364-2.535m12.728-5.07A9.007 9.007 0 0012 8c-2.435 0-4.663.952-6.364 2.535M4.929 12a9.008 9.008 0 0114.142 0M11.5 6.5h-1a2 2 0 100 4h1m-1 6h1a2 2 0 100-4h-1" />
    </svg>
);
